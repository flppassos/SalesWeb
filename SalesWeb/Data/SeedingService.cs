...
namespace SalesWeb.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1990, 06, 13), 1300.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1986, 03, 22), 1500.0, d3);
            Seller s3 = new Seller(3, "Alex Gray", "alex@gmail.com", new DateTime(1998, 11, 08), 1700.0, d2);
            Seller s4 = new Seller(4, "Marta Red", "marta@gmail.com", new DateTime(1984, 02, 10), 1650.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(1997, 08, 23), 1850.0, d1);
            Seller s6 = new Seller(6, "Alan Pink", "alan@gmail.com", new DateTime(1995, 09, 18), 1800.0, d2);

            SalesRecord r1 = new SalesRecord(1, new DateTime(2018, 09, 25), 1200.0, SaleStatus.Billed, s1);
